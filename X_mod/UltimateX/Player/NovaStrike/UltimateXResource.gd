...
func get_palette() -> Array:
	return [MainColor1, MainColor2, MainColor3, MainColor4, MainColor5, MainColor6, CrystalColor1, CrystalColor2, CrystalColor3, CrystalColor4]
