extends Node2D
class_name CrushCheck

export  var active: bool = true
export  var parent_signal: String = "zero_health"
...
onready var crush_vertical: Array = [crush_cast_up, crush_cast_down]
onready var crush_horizontal: Array = [crush_cast_left, crush_cast_right]
onready var crush_horizontal2: Array = [crush_cast_left, crush_cast_right]
