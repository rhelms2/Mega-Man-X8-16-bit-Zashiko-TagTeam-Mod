...
export (PackedScene) var object_to_spawn: PackedScene
export  var active: bool = true
export  var debug_logs: bool = false
export  var debug_extra_info: bool = false
export  var spawn_at_start: bool = false
export  var precise_area_spawn: bool = false
export  var make_child_of_this_object: bool = false
export  var wait_time_before_respawn: float = 6.0
export  var set_direction_to_right: bool = true
export  var start_inverted: bool = false
export  var despawnable: bool = true
export  var connect_teleport_events: bool = true
export  var active_time_offscreen: float = 8.0
...
var timer: float = 0.0
var time_of_spawn: float = 0.0
var time_of_death: float = 0.0
var time_outside_screen: float = 0.0
var spawned_object: Node2D
var debug_shutdown: bool = false
...
func object_spawned_child(spawned_child, should_despawn: bool = true) -> void :
