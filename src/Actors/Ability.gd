...
var input_activation: float = 0.1
var input: float = 0.0
var last_pressed_input: String = ""
var last_time_pressed: float = 0.0
var has_let_go_of_input: bool = false
...
func save_last_time_pressed() -> void :
	for element in actions:
...
func adjust_shot_position_on_initialize() -> void :
...
func adjust_shot_position(shot_adjustment) -> void :
