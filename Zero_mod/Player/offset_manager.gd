...
onready var hoverSprite = animatedSprite.get_node("HoverEffect")
onready var y_offset_deafult = - 1
onready var x_offset = 0
onready var y_offset = y_offset_deafult
onready var extra_x_offset = 0
onready var extra_y_offset = 0
